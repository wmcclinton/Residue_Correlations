...
$(BUILD)/res_correlation: $(BUILD)/res_correlation.o $(BUILD)/ensemble_res_comp.o gkut
	make svm.o -C $(SVM) \
	&& $(CXX) $(CFLAGS) -o $(BUILD)/res_correlation $(BUILD)/res_correlation.o $(BUILD)/ensemble_res_comp.o \
	$(SVM)/svm.o $(GKUT)/build/gkut_io.o $(GKUT)/build/gkut_log.o $(LINKGRO) $(LIBGRO) $(LIBS)

install: $(BUILD)/res_correlation
	install $(BUILD)/res_correlation $(INSTALL)

$(BUILD)/res_correlation.o: $(SRC)/res_correlation.c $(SRC)/ensemble_res_comp.h
	$(CC) $(CFLAGS) -o $(BUILD)/res_correlation.o -c $(SRC)/res_correlation.c $(DEFV5) $(INCGRO) -I$(SVM) -I$(GKUT)/include
...
clean:
	...
	&& rm -f $(BUILD)/*.o $(BUILD)/res_correlation